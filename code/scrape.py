...
class DocScrapper:
    ...
    def url_to_doc(self, url: str) -> None:
        ...
        page = reduce(lambda x,y: x+y, map(lambda x: str(x), filter(lambda x: x.name!='div' and x.name!='h2' and x.name!='h3', soup.find('div', class_='content').contents)))
...
print(DocScrapper().url_to_doc('https://learn.microsoft.com/en-us/power-bi/guidance/report-drillthrough'))